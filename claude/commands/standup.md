...
allowed-tools: [Read, Write, Glob, Grep, "Bash(python3 ~/.agent-toolkit/scripts/standup.py:*)", "Bash(python3 ~/.agent-toolkit/scripts/dev_status.py:*)", "Bash(git log:*)"]
---
<!-- generated by agent-scripts/gen_skills.py — do not edit; edit templates/standup.md.tmpl for shared wording or gen_skills.py's CAPABILITY_TABLE / *_PARAMS tables for harness-specific wording, then regenerate -->
