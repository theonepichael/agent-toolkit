...
---
<!-- generated by agent-scripts/gen_skills.py — do not edit; edit templates/refresh_guidance.md.tmpl for shared wording or gen_skills.py's CAPABILITY_TABLE / *_PARAMS tables for harness-specific wording, then regenerate -->
