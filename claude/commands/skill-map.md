...
---
1. Run `python3 ~/.agent-toolkit/scripts/gen_interfaces.py --check`. If it fails, stop and tell the user to regenerate `INTERFACES.md` first — an out-of-date file makes the map below untrustworthy.
