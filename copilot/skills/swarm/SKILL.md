...
allowed-tools: shell
---
<!-- generated by claude/scripts/gen_skills.py — do not edit; edit templates/swarm.md.tmpl for shared wording or gen_skills.py's CAPABILITY_TABLE / *_PARAMS tables for harness-specific wording, then regenerate -->
