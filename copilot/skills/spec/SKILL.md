...
1. File lives at the repo's `copilot/skills/spec/SKILL.md`.
...
3. Create the live symlink now: `ln -s "$(git rev-parse --show-toplevel)/copilot/skills/spec/SKILL.md" "~/.copilot/skills/spec/SKILL.md"`.
