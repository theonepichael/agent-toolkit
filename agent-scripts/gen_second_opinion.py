...
Usage:
    python3 agent-scripts/gen_second_opinion.py            rewrite every copy
    python3 agent-scripts/gen_second_opinion.py --check     exit 1 if any copy or
                                                              the contract shape
                                                              is stale
    python3 agent-scripts/gen_second_opinion.py --stdout    print the rendered
